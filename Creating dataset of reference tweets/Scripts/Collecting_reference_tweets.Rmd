...
```{r}
# Set up a .Renviron file

set_bearer() # Run and a .Renviron file will open, type 'TWITTER_BEARER=your_bearer_token'
# Save .Renviron file and restart R
...
tweets <- hydrate_tweets(tweet_ids,
                                 ...
                                 bind_tweets = FALSE, # When true, the tweets captured are bound into a data.frame
                                 data_path = "data/hydrate_trial") # 3 json files (for each batch) will be saved here
```
